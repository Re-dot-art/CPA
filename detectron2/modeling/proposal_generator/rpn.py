...
class RPN(nn.Module):
    ...
    def forward(
        ...
        # print("pred_objectness_logits==", len(pred_objectness_logits))
        
        # Transpose the Hi*Wi*A dimension to the middle:
        pred_objectness_logits = [
            # (N, A, Hi, Wi) -> (N, Hi, Wi, A) -> (N, Hi*Wi*A)      每一个锚点上的分数---分前景-背景
            score.permute(0, 2, 3, 1).flatten(1)
            for score in pred_objectness_logits
        ]
        # print("pred_objectness_logits--new==", pred_objectness_logits)
